...
The canonical contract is [[9-OpenAPI/openapi.yaml|openapi.yaml]]. This generated index reflects 95 operations across 70 path templates. All paths below are relative to `/api/v1`.
